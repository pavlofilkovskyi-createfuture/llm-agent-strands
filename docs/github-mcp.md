...
- **Request**: 
    ...
    - body:
        ```json
        {
            ...
            "params":{
                "protocolVersion":"1.0",
                "capabilities":{"supportsStdIo":true},
                "clientInfo":{
                    "name":"pavlo-client",
                    "version":"0.1.0"
                }
        ...
        ```json
        {
            ...
            "result": {
                ...
                "serverInfo": {
                    ...
                    "version": "github-mcp-server/remote-fc08b426742fd946e3c682abf63e055fefde374d"
                },
                "instructions": "<see instructions text below:>"
            }
        }
        ```
    - instructions text:
...
- **Request**:
    ...
    - headers: 
        - Content-Type: application/json
        - mcp-session-id: `<get this header from response to the Initialization request, see above>`
    - body:
    ```json
    {
        "jsonrpc": "2.0",
